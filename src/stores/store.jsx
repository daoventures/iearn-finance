      ...
      vaultAssets: [
        {
          ...
          vaultSymbol: 'daoUSDT',
          erc20address: '0xdac17f958d2ee523a2206206994597c13d831ec7',
          vaultContractAddress: '0xA0db955B5bdFA7C279CdE6C136FBA20C195CdEe5',
        ...
        },
        {
          ...
          vaultSymbol: 'daoUSDC',
          erc20address: '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48',
          vaultContractAddress: '0xa2609B2b43AC0F5EbE27deB944d2a399C201E3dA',
          vaultContractABI: config.vaultContractNewABI,
          balance: 0,
          vaultBalance: 0,
          decimals: 18,
        ...
        },
        {
          ...
          vaultSymbol: 'daoUSDC',
          erc20address: '0x6b175474e89094c44da98b954eedeac495271d0f',
          vaultContractAddress: '0x16de59092dAE5CcF4A1E6439D611fd0653f0Bd01',
          vaultContractABI: config.vaultContractNewABI,
          balance: 0,
          vaultBalance: 0,
          decimals: 6,
        ...
        },
        {
          ...
          vaultSymbol: 'TUSD',
          erc20address: '0x0000000000085d4780B73119b644AE5ecd22b376',
          vaultContractAddress: '0x73a052500105205d34daf004eab301916da8190f',
          vaultContractABI: config.vaultContractNewABI,
          balance: 0,
          vaultBalance: 0,
          decimals: 6,
        ...
        },
        {
          ...
          vaultSymbol: 'daowBTC',
          erc20address: '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599',
          vaultContractAddress: '0x04EF8121aD039ff41d10029c91EA1694432514e9',
          vaultContractABI: config.vaultContractNewABI,
          balance: 0,
          vaultBalance: 0,
          decimals: 6,
          ...
          measurement: 1e18,
          price_id: 'tether',
          strategyName: 'Yearn-Farmer: wBTC',
          strategy: 'wBTC',
        },
      ],
      aprs: [{
  ...
  getVaultBalancesFull = async (interval) => {
    ...
    async.map(assets, (asset, callback) => {
      async.parallel([
        ...
        asset.pricePerFullShare = data[4].pricePerFullShare
